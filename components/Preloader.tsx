      ...
      <div className={`relative z-30 flex flex-col items-center justify-center transition-all duration-800 ${isExiting ? 'opacity-0 scale-90 blur-xl' : 'opacity-100 scale-100'}`}>
         ...
         <div className="flex flex-col items-center gap-4 mb-10">
             <div className="flex items-baseline gap-3 min-w-[200px] justify-center">
                <span className="font-serif text-[10vh] md:text-[12vh] leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-stone-200 to-stone-500 font-medium tabular-nums">
                    {progress}
                </span>
                <span className="text-art-primary font-bold text-lg md:text-xl">%</span>
             </div>
             <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] md:tracking-[0.6em] text-white/40 text-center">Curating the Masterpieces</span>
         </div>
