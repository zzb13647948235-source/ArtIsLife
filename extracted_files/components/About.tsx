  ...
  return (
    <div className="min-h-screen pt-32 pb-20 bg-transparent">
       <div className="max-w-[1800px] mx-auto px-6 md:px-12">
          ...
          {/* Hero Text */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 mb-32 items-end animate-fade-in-up">
              <div>
                 <span className="text-art-primary font-bold text-xs uppercase tracking-[0.3em] mb-6 block">Our Mission</span>
                 <h2 className="font-serif text-6xl md:text-8xl text-art-accent leading-[0.9]">
                    Bridging <br/> Eras.
                 </h2>
              </div>
              <div className="pb-4">
                 <p className="text-xl md:text-2xl text-stone-600 font-light leading-relaxed text-justify">
          ...
          {/* Visual Story */}
          <div className="relative h-[60vh] md:h-[80vh] w-full overflow-hidden rounded-sm mb-32 group">
             <img 
          ...
          {/* Values Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-art-accent/10 pt-24">
             <div className="space-y-6">
                <span className="font-mono text-xs text-art-muted">01</span>
                <h3 className="font-serif text-3xl text-art-accent">尊重经典</h3>
             ...
             <div className="space-y-6">
                ...
                <h3 className="font-serif text-3xl text-art-accent">技术赋能</h3>
                <p className="text-stone-500 leading-loose">
             ...
             <div className="space-y-6">
                ...
                <h3 className="font-serif text-3xl text-art-accent">灵感社区</h3>
                <p className="text-stone-500 leading-loose">
